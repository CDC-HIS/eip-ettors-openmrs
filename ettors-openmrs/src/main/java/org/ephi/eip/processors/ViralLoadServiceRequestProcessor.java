...
public class ViralLoadServiceRequestProcessor implements Processor {
    ...
    public void process(Exchange exchange) {
        ...
        if (serviceRequest != null) {
            ...
            try {
                exchange.getMessage().setBody(new ObjectMapper().writeValueAsString(payload));
    ...
    private ViralLoadRequestPayload assembleViralLoadRequestPayload(Patient patient, Encounter encounter, Location location) {
        ...
        viralLoadRequestPayload.setRequestedDate(encounter.getPeriod().getStart().toString());
        ...
        viralLoadRequestPayload.setSpecimenCollectedDate("N/A");
        viralLoadRequestPayload.setSpecimenType("Blood");
        viralLoadRequestPayload.setSpecimenSentToReferralDate("N/A");
        viralLoadRequestPayload.setLabId("Lab 1");
        viralLoadRequestPayload.setLabName("Lab 1");
        viralLoadRequestPayload.setSpecimenReceivedDate("N/A");
        ...
        viralLoadRequestPayload.setTestResultDate("N/A");
        viralLoadRequestPayload.setReviewedBy("N/A");
        viralLoadRequestPayload.setAlertSentDate("N/A");
        viralLoadRequestPayload.setDispatchDate("N/A");
        viralLoadRequestPayload.setResultReachedToFacDate("N/A");
        viralLoadRequestPayload.setResultReceivedByFacility("N/A");
        viralLoadRequestPayload.setAttachedToPatientDate("N/A");
        viralLoadRequestPayload.setCommunicatedToPatientDate("N/A");
